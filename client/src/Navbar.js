      ...
      <div>
        ...
        >
          <div class="d-flex justify-content-between w-100">
            <a class="navbar-brand ps-2">Navbar</a>
            <div className="d-flex">
              ...
              <button className='btn btn-primary me-2' data-bs-toggle="modal" data-bs-target="#signin">SignIn</button>
              <button className='btn btn-primary me-2' data-bs-toggle="modal" data-bs-target="#signup">SignUp</button>
            </div>
          </div>
        </nav>
        ...
        <div className='modal-dialog modal-dialog-centered'>
          <div class="modal fade" id="signup" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content text-white" style={{ 'background-color': '#262c36' }}>
                ...
                <div class="modal-body">
                  <input
                    type="text"
                    class="form-control border-0 shadow-none text-light placeholder-secondary mb-3"
                    placeholder="Name"
                    id="currentPass"
                    style={{ 'background-color': '#15181e' }}
                  />
